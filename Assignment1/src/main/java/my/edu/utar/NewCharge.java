...
public class NewCharge {
	OrderFunctionality of;
	PrintingFunctionality pf;
	...
	public NewCharge (OrderFunctionality of, PrintingFunctionality pf) {
		this.of = of;;
		this.pf = pf;
	}
