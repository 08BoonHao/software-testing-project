...
public class NewOrder implements OrderFunctionality{
	private String type;
	private int option;
	...
	public NewOrder (String type, int option, int quantity, String addOption1, String addOption2) {
		this.type = type;
		this.option = option;
